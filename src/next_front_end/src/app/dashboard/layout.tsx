        ...
        <html lang="es" suppressHydrationWarning={true} >
            ...
            <body>
                <HydrateZustandProvider user={user}> 
                    <div className="grid grid-cols-1 md:h-dvh md:max-w-[700px] md:mx-auto md:grid-cols-[1fr_350px] md:grid-rows-[55px_100px_125px_1fr] xl:max-w-full xl:grid-cols-[200px_1fr_250px] xl:grid-rows-[55px_250px_1fr]  min-h-full xl:pt-2 pt-20 px-2  gap-4 py-4">
                        <ResponsiveMenu />
                        <InfoUser user={user} />
                        <Calendar />
                        <MeetsDay />
