...
const MoonIcon = (
  <svg xmlns="http://www.w3.org/2000/svg" fill="var(--white-peristance-color)" viewBox="0 0 384 512" style={{ height: "15px", width: "15px", rotate: "-18deg" }}>
