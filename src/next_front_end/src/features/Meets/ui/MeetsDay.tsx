...
export default function MeetsDay() {
    ...
    return (
        <section className="w-full max-w-[350px] row-start-3 md:col-start-2 md:row-start-3 xl:row-start-3 xl:col-start-3 xl:max-w-[250px] bg-[rgba(24,44,2)] p-4 rounded-lg flex flex-col  mt-2">
            <div className="flex items-center justify-between">
                ...
                <button  className="font-medium text-xl bg-[var(--green-dark-500)] rounded-full flex w-8 h-8 items-center justify-center">+</button>
            </div>
