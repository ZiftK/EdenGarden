...
export default function MeetsDay() {
    ...
    return (
        <section className="w-full max-w-[350px]  md:col-start-2 md:row-start-3 xl:row-start-3 xl:col-start-3 xl:max-w-[250px] bg-[rgba(24,44,2)] p-4 rounded-lg flex flex-col  mt-2">
