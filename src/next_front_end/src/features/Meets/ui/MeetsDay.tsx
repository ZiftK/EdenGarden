            ...
            <div className="mt-3">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-2">
                        ...
                        <p className="text-blue-300 text-sm ">https://meet/avs#...</p>
                    </div>
