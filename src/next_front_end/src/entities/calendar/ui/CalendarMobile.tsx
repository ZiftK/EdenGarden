...
export default function CalendarDesktop({date}: {date: Date}) {
    ...
    return(
        <div className=" w-full max-w-[350px] md:col-start-2 lg:hidden bg-[rgba(56,86,24,0.69)] pt-1.5 pb-2.5 rounded-lg flex flex-col justify-center items-center mt-2">
