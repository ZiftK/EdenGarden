...
export default function CalendarButtons() {
	...
	return (
		<div className='hidden xl:flex w-full max-w-[450px] bg-[rgba(24,44,2)] p-4 rounded-lg flex-col items-center mt-2 select-none lg:!col-start-3'>
			{/* HEADER: Botones + Mes */}
			...
			<div className='grid grid-cols-7 gap-1 text-center w-full'>
				{['L', 'M', 'M', 'J', 'V', 'S', 'D'].map((day, index) => (
					<div
						key={index}
						className='text-gray-100/40 text-[10px] font-semibold'
					>
						{day}
					</div>
				))}
